...
function Main() {
    ...
    const { data, isFetching, refetch } = useGetUsersList(pagination)
    ...
    const handleFreezeUser = ({
        ...
        freezeMutation.mutate(
            { id: selectedUser, freezeDateTo: inactiveDateTo },
            {
                onSuccess: () => {
    ...
    return isFetching ? (
        ...
        <>
            <h2 className="mt-10 text-lg font-medium intro-y">Customers</h2>
                    ...
                    <Dialog.Description className="grid grid-cols-full gap-4 gap-y-3">
                        ...
                        >
                            <div className="col-span-12">
                                ...
                                />
                                {errors.inactiveDateTo?.type === "required" && (
                                    <div className="mt-2 text-danger">
                                        "Date is reuqired"
                                    </div>
                                )}
                                {errors.inactiveDateTo?.type === "validate" && (
                                    <div className="mt-2 text-danger">
                                        "Enter a valid date"
                                    </div>
                                )}
